...
export const Home = () => {
  return (
    <>
    <section style={{ height: "90vh", position:"relative" }} className=" mt-24 mb-24 md:mb-3" >
    <img
      ...
      <section style={{ height: "55vh" }} >
        <div className="">
        <h1 className="text-2xl text-center md:text-4xl mx-2 mb-5 text-black font-bold md:leading-10">
        Explore Our Offerings
            </h1>
          <div className="grid grid-cols-3 md:grid-cols-5 md:mx-40">
      ...
      <section style={{ height: "90vh", position:"relative" }} className="  mb-24 md:mb-3" >
            ...
            <ul className="m-8">
              <li className="text-lg">
                <span>
                 ...
                 <span className="text-white text-bold text-xl ">Welcome</span> to The Event Horizon, your premier destination for hassle-free event planning in Yavatmal City, Maharashtra. Founded with a vision to revolutionize event organization, we are dedicated to providing our customers with the best selection of services, all at your fingertips.
              ...
              <li className="text-lg mt-2">
                ...
                Discover a world of possibilities with The Event Horizon. Whether you're planning a wedding, a corporate event, or a family celebration, we offer a variety of services to suit your needs. From booking lawns and wedding halls to arranging decorations, DJs, and food catering, we've got you covered.
      ...
      <section  className="h-full mb-0 mt-5">
        <Footer/>
      </section>
    </>
  );
